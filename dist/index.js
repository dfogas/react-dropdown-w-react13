...
var Dropdown = (function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var dropdownClass = (0, _classnames2['default'])((_classNames = {}, _defineProperty(_classNames, '' + baseClassName + '-root', true), _defineProperty(_classNames, 'is-open', this.state.isOpen), _classNames));
